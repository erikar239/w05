...
public class ToDoItem implements Serializable {
	...
	private String state; // variable must be called "finished" - same as in JSON from front-end
	...
	public String toString() {
		return "ToDoItem [title=" + title + ", text=" + text + ", state =" + state + ", createdAt=" + createdAt
